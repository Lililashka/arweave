  ...
  return (
    <Layout withAos withHexagonBg className="homepage">
      ...
      <CardLinkSection aosConfig={{ "data-aos": "fade-up", "data-aos-easing": "linear", "data-aos-duration": "500" }} 
        ...
        desc="Arweave is a new type of storage that backs data with sustainable and perpetual endowments, allowing users and developers to truly store data forever for the very first time. How? 
