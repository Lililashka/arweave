...
As part of our focus on [fostering and improving the ecosystem](/get-involved/grants-funding), the founding Arweave team is proud to offer a number of financial reward programmes to support those building on the Arweave network:
...
- The Arweave [grants and investment](/get-involved/grants-funding) programme: Propose a grant or investment opportunity to establish your new Arweave based project and we will you help fund it.
...
### Interfaces
<a className="anchor" id="interfaces"/>
